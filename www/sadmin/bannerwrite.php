      ...
      <table width="880" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td  width="730"><input type="text" name="moveurl" size="80"  id="moveurl" title="연결주소" maxlength="250" class="FORM1"  value="<?=$row_board[moveurl]?>">
			...
			<input type="radio" name="actiontype" value="self" <?if($row_board[actiontype]=="self") echo"checked"; else if(!$row_board[actiontype]) echo "checked";?>>자체창
			<input type="radio" name="actiontype" value="blank" <?if($row_board[actiontype]=="blank") echo"checked"; ?>>새창
		  </td>
        </tr>
        <tr>
          <td height="1" colspan="2" bgcolor="#ebebeb"></td>
