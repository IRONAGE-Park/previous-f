...
?>
	<form name="listform" method="post"> 	
	  <table width="880" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="105" align="center" background="img/admin_14.gif"><font  class="T4">이름</font></td>
		<?if($MODEUSETYPE=="Y"){?>
	...
	?>
		...
		<?}?>
		  ...
		  <?if($MODEUSETYPE=="Y"){?>
          <td align="center"><a href="<?echo"$_SERVER[PHP_SELF]?bmain=ok"?>&uid=<?=$result[$i][uid]?>&formmode=modify1&mode=2"><?=$font_color?><?=$ARR_BOARD_TYPE[$result[$i][mode]]?></font></a></td>
		  <?}?>
