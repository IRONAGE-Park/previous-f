...
############### DB 정보를 가지고 온다 ####################
  ...
  <?}?>
      ...
      <table width="880" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<?if($MODEUSETYPE=="Y"){?>
        <tr> 
          <td height="35"><font class="T4">ㆍ진행여부</font></td>
          <td>

			<select name="mode" class="FORM1">
					<option value="">- 진행여부 -</option>
				<? for($j=1;$j<=count($ARR_BOARD_TYPE);$i++,$j++) { ?>
					<option value="<?=$j?>" <?if($row_board[mode]=="$j") echo"selected"; if(!$row_board[mode] and $j==$mode_a)echo"selected";?>><?=$ARR_BOARD_TYPE[$j]?></option>
				<?}?>
			</select>
		...
		<?if($MODEUSETYPE1=="Y"){?>
        <tr> 
          <td height="35"><font class="T4">ㆍ나라선택</font></td>
          <td>
			<select name="mode1" class="FORM1">
					<option value="">- 나라선택 -</option>
				<? for($j=1;$j<=count($ARR_BOARD_TYPE1);$i++,$j++) { ?>
					<option value="<?=$j?>" <?if($row_board[mode1]=="$j") echo"selected";?>><?=$ARR_BOARD_TYPE1[$j]?></option>
				<?}?>
			</select>
		  </td>
        </tr>
		...
		<?}?>
        <tr> 
          <td height="35"><font class="T4">ㆍ기간</font></td>
          <td>
        ...
        <tr> 
          ...
          <td>
			...
			<input type="file" name="fileadd" size=50 > (썸네일)
			...
			<input type="file" name="fileadd1" size=50> (첨부파일)
