...
if($conf) {
    ...
    switch( $formmode ){        
		...
		########### 저장하기 처리 ##################		
			...
			$tran_query[0] = "INSERT INTO $tablename (uid,mid,title,mode,mode1,sdate,edate,viewtype,pass,uname,uemail,content,content1,topview,ref,fidnum,thread,fileadd_name,fileadd_org,fileadd1_name,fileadd1_org,keytype,reg_date) VALUES ('$new_uid','$SITE_ADMIN_MID','$title','$mode','$mode1','$sdate','$edate','$viewtype','$pass','$uname','$uemail','$content','$content1','$topview','$ref','$new_fidnum','A','$fileadd_name_1','$fileadd_org','$fileadd_name_2','$fileadd1_org','$keytype','$reg_date')";
		...
		########### 수정 하기 처리 ##################		
			...
			$tran_query[0] = "UPDATE $tablename SET mid='$SITE_ADMIN_MID',title='$title',mode='$mode',mode1='$mode1',sdate='$sdate',edate='$edate',viewtype='$viewtype',pass='$pass',uname='$uname',uemail='$uemail',content='$content',topview='$topview',ref='$ref',keytype='$keytype',reg_date='$reg_date' $file_sql $file_sql_1 $content_slq WHERE uid='$uid'";
			$tran_result = $db->tran_query( $tran_query );
