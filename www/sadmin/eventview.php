...
?>
	...
	<script type="text/javascript">
	  ...
	  <tr>
        ...
        <tr> 
          <td width="12%" height="35"><font class="T4">ㆍ기간</font></td>
          <td ><strong><?=$row_board[sdate]?> ~ <?=$row_board[edate]?></strong></td>
        </tr>
	    <tr>
			<td height="1" colspan="4" bgcolor="#ebebeb"></td>
	    </tr>
        <tr> 
          <td width="12%" height="35"><font class="T4">ㆍ나라</font></td>
          <td ><strong><?=$ARR_BOARD_TYPE1[$row_board[mode1]]?></strong></td>
        </tr>
	    <tr>
			<td height="1" colspan="4" bgcolor="#ebebeb"></td>
	    </tr>
