	...
	<script type="text/javascript">
	  ...
	  <tr>
        ...
        <tr> 
          ...
          <td width="25%"><?=$row_board[uname]?> </td>
	  ...
	  <tr>
        ...
        <tr> 
          <td width="12%" height="35"><font class="T4">ㆍ상품명</font></td>
        ...
        <tr> 
          <td width="12%" height="35"><font class="T4">ㆍCode</font></td>
          <td ><strong><?=$row_board[title1]?></strong></td>
        </tr>
	    <tr>
			<td height="1" colspan="4" bgcolor="#ebebeb"></td>
	    </tr>
        <tr> 
          <td width="12%" height="35"><font class="T4">ㆍSize</font></td>
          <td ><strong><?=$row_board[title2]?></strong></td>
        </tr>
	    <tr>
			<td height="1" colspan="4" bgcolor="#ebebeb"></td>
	    </tr>
        <tr> 
          <td width="12%" height="35"><font class="T4">ㆍ원산지</font></td>
          <td ><strong><?=$row_board[title3]?></strong></td>
        </tr>
	    <tr>
			<td height="1" colspan="4" bgcolor="#ebebeb"></td>
	    </tr>
        ...
        <tr> 
          ...
          <td width="86%"><div align="justify"><br />
			<?//if($BOARD_TYPE=="PHOTO") {
				...
				if($row_board[fileadd2_name]) {
					$file_size=GetImageSize("$ROOT_PATH/$tablefile/$row_board[fileadd2_name]");
					if($file_size[0] > 650) $img_width2 = "650";
					else  $img_width2 = "$file_size[0]";
					$board_img = "<a class=\"fancybox-effects-d\" href=\"$HOME_PATH/$tablefile/$row_board[fileadd2_name]\" title=\"$row_board[title]\"><img src='$HOME_PATH/$tablefile/$row_board[fileadd2_name]' border=0  width='$img_width2'></a><br><br>";
					echo "$board_img";
				}
				if($row_board[fileadd3_name]) {
					$file_size=GetImageSize("$ROOT_PATH/$tablefile/$row_board[fileadd3_name]");
					if($file_size[0] > 650) $img_width3 = "650";
					else  $img_width3 = "$file_size[0]";
					$board_img = "<a class=\"fancybox-effects-d\" href=\"$HOME_PATH/$tablefile/$row_board[fileadd3_name]\" title=\"$row_board[title]\"><img src='$HOME_PATH/$tablefile/$row_board[fileadd3_name]' border=0  width='$img_width3'></a><br><br>";
					echo "$board_img";
				}
				if($row_board[fileadd4_name]) {
					$file_size=GetImageSize("$ROOT_PATH/$tablefile/$row_board[fileadd4_name]");
					if($file_size[0] > 650) $img_width4 = "650";
					else  $img_width4 = "$file_size[0]";
					$board_img = "<a class=\"fancybox-effects-d\" href=\"$HOME_PATH/$tablefile/$row_board[fileadd4_name]\" title=\"$row_board[title]\"><img src='$HOME_PATH/$tablefile/$row_board[fileadd4_name]' border=0  width='$img_width4'></a><br><br>";
					echo "$board_img";
				}
			//}?>
		...
		<?if($row_board[fileadd_name] OR $row_board[fileadd1_name]) {
			...
			if($row_board[fileadd2_name]) $row_board[fileadd2_size] = filesize("$ROOT_PATH/$tablefile/$row_board[fileadd2_name]");	
			if($row_board[fileadd3_name]) $row_board[fileadd3_size] = filesize("$ROOT_PATH/$tablefile/$row_board[fileadd3_name]");	
			if($row_board[fileadd4_name]) $row_board[fileadd4_size] = filesize("$ROOT_PATH/$tablefile/$row_board[fileadd4_name]");	
		?>
        <tr> 
		  ...
		  <? if($row_board[fileadd_name]) { echo"<a href='$PHP_SELF?down=$row_board[fileadd_name]&file_name=$row_board[fileadd_name]&size=$row_board[fileadd_size]&board_name=$tablefile' class='L3'>"?><?=$row_board[fileadd_org]?> (<?=number_format($row_board[fileadd_size])?>k)</a><?}?>
		   ...
		   <? if($row_board[fileadd2_name]) { echo"<a href='$PHP_SELF?down=$row_board[fileadd2_name]&file_name=$row_board[fileadd2_name]&size=$row_board[fileadd2_size]&board_name=$tablefile' class='L3'>"?><?=$row_board[fileadd2_org]?> (<?=number_format($row_board[fileadd2_size])?>k)</a><?}?>

		   <? if($row_board[fileadd3_name]) { echo"<a href='$PHP_SELF?down=$row_board[fileadd3_name]&file_name=$row_board[fileadd3_name]&size=$row_board[fileadd3_size]&board_name=$tablefile' class='L3'>"?><?=$row_board[fileadd3_org]?> (<?=number_format($row_board[fileadd3_size])?>k)</a><?}?>

		   <? if($row_board[fileadd4_name]) { echo"<a href='$PHP_SELF?down=$row_board[fileadd4_name]&file_name=$row_board[fileadd4_name]&size=$row_board[fileadd4_size]&board_name=$tablefile' class='L3'>"?><?=$row_board[fileadd4_org]?> (<?=number_format($row_board[fileadd4_size])?>k)</a><?}?>
