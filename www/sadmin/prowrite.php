...
############### DB 정보를 가지고 온다 ####################
  ...
  <?}?>
      ...
      <table width="880" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td height="35"  width="150"><font class="T4">ㆍ상품명</font></td>
        ...
        <tr> 
          <td height="35"  width="150"><font class="T4">ㆍCode</font></td>
          <td  width="730"><input type="text" name="title1" size="80" maxlength="250" class="FORM1"  value="<?=$row_board[title1]?>"></td>
        </tr>
		<tr>
          <td height="1" colspan="2" bgcolor="#ebebeb"></td>
        </tr>
        <tr> 
          <td height="35"  width="150"><font class="T4">ㆍSize</font></td>
          <td  width="730"><input type="text" name="title2" size="80" maxlength="250" class="FORM1"  value="<?=$row_board[title2]?>"></td>
        </tr>
		<tr>
          <td height="1" colspan="2" bgcolor="#ebebeb"></td>
        </tr>
        <tr> 
          <td height="35"  width="150"><font class="T4">ㆍ원산지</font></td>
          <td  width="730"><input type="text" name="title3" size="80" maxlength="250" class="FORM1"  value="<?=$row_board[title3]?>"></td>
        </tr>
		<tr>
          <td height="1" colspan="2" bgcolor="#ebebeb"></td>
        </tr>
        <tr> 
          <td height="35"  width="150"><font class="T4">ㆍ판매가</font></td>
          <td  width="730"><input type="text" name="title4" size="80" maxlength="250" class="FORM1"  value="<?=$row_board[title4]?>"></td>
        </tr>
		<tr>
          <td height="1" colspan="2" bgcolor="#ebebeb"></td>
        </tr>
        <tr> 
          <td height="35"  width="150"><font class="T4">ㆍ할인가</font></td>
          <td  width="730"><input type="text" name="title5" size="80" maxlength="250" class="FORM1"  value="<?=$row_board[title5]?>"></td>
        </tr>
		<tr>
          <td height="1" colspan="2" bgcolor="#ebebeb"></td>
        </tr>
        ...
        <tr> 
          ...
          <td>
			...
			?>
				삭제 <input type="checkbox" name="delimg_1" value="Y" class="border"> <?echo"<a href='$PHP_SELF?down=$row_board[fileadd_name]&file_name=$row_board[fileadd_name]&size=$row_board[fileadd_size]&board_name=$tablefile'>"?><?=$row_board[fileadd_org]?></a><?}?> (리스트)<br>
			...
			?>
				삭제 <input type="checkbox" name="delimg_2" value="Y" class="border"> <?echo"<a href='$PHP_SELF?down=$row_board[fileadd1_name]&file_name=$row_board[fileadd1_name]&size=$row_board[fileadd1_size]&board_name=$tablefile'>"?><?=$row_board[fileadd1_org]?></a><?}?> (1.제품상세) <br>

			<input type="file" name="fileadd2" size=50> 
			<?if($row_board[fileadd2_name]) {
				$row_board[fileadd2_size] = filesize("$ROOT_PATH/$tablefile/$row_board[fileadd2_name]");	
			?>
				삭제 <input type="checkbox" name="delimg_3" value="Y" class="border"> <?echo"<a href='$PHP_SELF?down=$row_board[fileadd2_name]&file_name=$row_board[fileadd2_name]&size=$row_board[fileadd2_size]&board_name=$tablefile'>"?><?=$row_board[fileadd2_org]?></a><?}?> (2.제품상세) <br>


			<input type="file" name="fileadd3" size=50> 
			<?if($row_board[fileadd3_name]) {
				$row_board[fileadd3_size] = filesize("$ROOT_PATH/$tablefile/$row_board[fileadd3_name]");	
			?>
				삭제 <input type="checkbox" name="delimg_4" value="Y" class="border"> <?echo"<a href='$PHP_SELF?down=$row_board[fileadd3_name]&file_name=$row_board[fileadd3_name]&size=$row_board[fileadd3_size]&board_name=$tablefile'>"?><?=$row_board[fileadd3_org]?></a><?}?> (3.제품상세) <br>

			<input type="file" name="fileadd4" size=50> 
			<?if($row_board[fileadd4_name]) {
				$row_board[fileadd4_size] = filesize("$ROOT_PATH/$tablefile/$row_board[fileadd4_name]");	
			?>
				삭제 <input type="checkbox" name="delimg_5" value="Y" class="border"> <?echo"<a href='$PHP_SELF?down=$row_board[fileadd4_name]&file_name=$row_board[fileadd4_name]&size=$row_board[fileadd4_size]&board_name=$tablefile'>"?><?=$row_board[fileadd4_org]?></a><?}?> (4.제품상세) <br>
