...
/*
    ...
    */
    ...
    function paging( $pageurl, $total_num, $pagesize, $pagePerBlock, $page, $search){
            ...
            $nav = '<li><a href="'.$pageurl.'?page=1' . $search.'" class="btn-start" ><img src="../Bimg/btn-paging-start.gif" alt="첫 페이지로 이동" ></a></li>';

            if($isPrev){
                $goPrevPage = $startPage-$pagePerBlock; // 11page
                $nav .= '<li><a href="'.$pageurl.'?page=' . $goPrevPage .  $search . '" class="btn-prev"><img src="../Bimg/btn-paging-prev.gif" alt="이전 페이지로 이동"></a></li>';
            }
            ...
            if($isNext){
                ...
                $nav .= '<li><a href="' . $pageurl . '?page=' . $goNextPage . $search . '" class="btn-next"><img src="../Bimg/btn-paging-next.gif" alt="다음 페이지로 이동"></a></li>';
            }
            $nav .= '<li><a href="' . $pageurl . '?page=' . $totalNumOfPage . $search . '" class="btn-end"><img src="../Bimg/btn-paging-end.gif" alt="마지막 페이지로 이동"></a></li>';
            return $nav;
    }
    ...
    function paging_new( $pageurl, $total_num, $pagesize, $pagePerBlock, $page, $search){
            ...
            $nav = '<td><div class="sub02_numbox"><a href="'.$pageurl.'?page=1' . $search.'" class="sub02_num"><img src="/Bimg/btn-paging-start.gif" border="0" /></a></div></td>';

            if($isPrev){
                $goPrevPage = $endPage-1; // 11page
                $nav .= '<td><div class="sub02_numbox"><a href="'.$pageurl.'?page=' . $goPrevPage .  $search . '" class="sub02_num"><img src="/Bimg/btn-paging-prev.gif" border="0" /></a></div></td>';
            }
            ...
            for($i=$startPage;$i<=$endPage;$i++){
                ...
                if($i==$page) {
                        ...
                        $nav .=  '<td><div class="sub03_numbox"><a href="javascript:;" class="sub02_num">'.$i.'</a></div></td>';

                } else {
                        $nav .=  '<td><div class="sub02_numbox"><a href="' . $pageurl . '?page=' . $i . $search . '" class="sub02_num">'.$i.'</a></div></td>';
                }
            }

            if($isNext){
                $goNextPage = $startPage+$page; // 11page
                $nav .= '<td><div class="sub02_numbox"><a href="' . $pageurl . '?page=' . $goNextPage . $search . '" class="sub02_num"><img src="/Bimg/btn-paging-next.gif"  border="0" /></a></div></td>';
            }
            $nav .= '<td><div class="sub02_numbox"><a href="' . $pageurl . '?page=' . $totalNumOfPage . $search . '" class="sub02_num"><img src="/Bimg/btn-paging-end.gif" border="0" /></a></div></td>';
            return $nav;
    }
