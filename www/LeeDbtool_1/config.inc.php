 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://thef.freewebclub.com/LeeDbtool_1/';
...
$cfg['Servers'][$i]['user']          = 'fw_thef';      // MySQL user
$cfg['Servers'][$i]['password']      = 'thef2014';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'fw_thef';          // If set to a db-name, only
