...
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td align="right"><table border="0" cellspacing="5" cellpadding="0">
	 <tr>
	  ...
	  <td><input type="image"  src="../img/button/search_small.gif"></td>
	 </tr>
	</table></td>
   </tr>
  </table></td>
 ...
 <tr>
  <td valign="top">
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
        <td width="8%" align="center" class="qna_list01">번호</td>
        <td align="center" class="qna_list01">제목</td>
        <td width="12%" align="center" class="qna_list01">작성자</td>
        <td width="13%" align="center" class="qna_list01">작성일</td>
        <td width="8%" align="center" class="qna_list01">조회</td>
        </tr>
	...
	?>
			<tr>
				<td>[공지]</td>
				<td class="subject">
					<a href="<?=$link_page?>"><?=$common->cut_string($result1[$t][title],43)?></a><img src="../asset/img/main/ico_new.png" alt="new">
				</td>
	...
	?>
       ...
       <tr>
        ...
        <td class="qna_list02">
			<a href="<?=$link_page?>"><?=$common->cut_string($result[$i][title],43)?></a><?=$hold?><? if($today==$result[$i][reg_date]) echo " <img src='../asset/img/main/ico_new.png' alt='new'>"; ?>
		</td>
        <td align="center" class="qna_list02"><?=$result[$i][uname]?></td>
        <td align="center" class="qna_list02"><?=$common->dateStyle(substr($result[$i][reg_date],0,10),".")?></td>
        <td align="center" class="qna_list02"><?=$result[$i][ref]?></td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
        ...
        <td align="right" style="padding:20px 0 100px 0" width=100>
			<?if($MEMBER_WRITE=="Y") {?>
			<a href="<?echo"$_SERVER[PHP_SELF]?bmain=write"?>" class="btn-form01"><img src="../img/button/write.gif" alt="글쓰기"></a>
			<?}?>
		</td>
       </tr>
      </table>
