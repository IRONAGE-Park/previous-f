	...
	<?}?>
	 ...
	 <tr>
	  <td align="center" style="padding:20px 0 50px 0">
		  <a href="javascript:;" onClick="boardWritecheck();" ><img src="../img/button/write.gif" alt="확인" hspace="2"></a><a href="<?echo"$_SERVER[PHP_SELF]?bmain=list"?>"><img src="../img/button/list.gif" hspace="2"></a></td>
	 </tr>
	</table>
	</form>
