			...
			<table width="260" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><a href="<?=$link_page?>">
						<? 
						if($my_fileadd_name) {
							echo "<img src='$HOME_PATH/$tablefile/$my_fileadd_name' border=0 height=196 width='260'></a></td>";
							} else {
							echo "<img src=$HOME_PATH/Bimg/no_image.gif border=0  height=196 width='260'></a></td>";
							}
						?>
					</a></td>
				</tr>
				<tr>
					<td style="padding:10px 0 60px 0" align="center"><a href="<?=$link_page?>"><?=$common->cut_string($result[$i][title],43)?></a><? if($today==$result[$i][reg_date]) echo " <img src='../asset/img/main/ico_new.png' alt='new'>"; ?></td>
				</tr>
			</table>
